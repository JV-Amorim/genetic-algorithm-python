...
from population import generate_initial_population, select_individuals_for_the_next_generation
...
if __name__ == '__main__':
  ...
  for population_index in range(NUMBER_OF_GENERATIONS):
    ...
    new_population = select_individuals_for_the_next_generation(current_population)
